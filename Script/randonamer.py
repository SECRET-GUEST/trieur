...
class randonaming(QWidget):
    def __init__(self):
        ...
        self.dic2 = ["astrologie", "numérologie", "théosophie", "alchimie", "kabbale", "hermétisme", "occultisme", "mysticisme", "gnosticisme", "spiritisme", "ésotérisme", "parapsychologie", "magnétisme", "clairvoyance", "chamanisme", "divination", "pouvoir", "médiumnité", "réincarnation", "esprit", "ouija", "mystère", "infini", "vibration", "oracle", "religion", "sagesse", "magie", "astrologue", "hermétiste", "occultiste", "mystique", "gnostique", "spirite", "parapsychologue", "magnétiseur", "clairsentient", "chamane", "divin", "médium", "égrégore", "fantôme", "démonologie", "chakras", "tarot", "Runes", "ange", "symbolisme"]
